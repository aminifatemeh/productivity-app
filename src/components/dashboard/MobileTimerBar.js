...
const MobileTimerBar = ({ selectedTask }) => {
  const { timers, startTimer, stopTimer, resetTimerForTask, tasks } =
    ...
    <div className="mobile-timer-bar">
      <div className="mobile-timer-bar__content">
        <div className="mobile-timer-bar__info">
          {selectedTask ? (
            <>
              <span className="mobile-timer-bar__task-name">
                {selectedTask.title}
              </span>
              <span className="mobile-timer-bar__times">
                <span className="mobile-timer-bar__time">
                  {formatTime(time)}
                </span>
                  {totalTime > 0 && (
                      <span className="mobile-timer-bar__total-time">
            ...
            <span className="mobile-timer-bar__placeholder">
              هیچ تسکی انتخاب نشده
            </span>
          )}
        </div>
